...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "watch";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "watch.war")
            ...
            .addPackages(false, "flipkart5") // not recursive to skip package 'nonarquillian'
